<template>
  <q-page class="q-pa-md">
    ...
    <q-card class="q-mb-md">
      <q-card-section>
        <div class="text-h6 q-mb-sm">Crop Chart Prototype</div>
    ...
    <q-card v-if="loading" class="q-pa-md"> Loading reports... </q-card>
...
import CropChart from 'src/components/CropChart.vue'
